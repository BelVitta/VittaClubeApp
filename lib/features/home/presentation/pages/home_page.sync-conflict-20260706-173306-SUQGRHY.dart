...
class _HomeViewState extends State<_HomeView> with WidgetsBindingObserver {
  ...
  bool _hasShownNoPlanPromotion = false;
  ...
  Widget build(BuildContext context) {
    return BlocListener<SubscriptionBloc, SubscriptionState>(
      ...
      listener: (context, state) => _showNoPlanPromotion(),
      child: Scaffold(
  ...
  void _showNoPlanPromotion() {
    if (_hasShownNoPlanPromotion) return;
    _hasShownNoPlanPromotion = true;
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (!mounted) return;
      showDialog<void>(
        context: context,
        builder: (dialogContext) => NoPlanPromotionDialog(
          onViewPlans: () {
