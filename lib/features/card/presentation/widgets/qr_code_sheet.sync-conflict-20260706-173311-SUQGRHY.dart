...
class QrCodeSheet extends StatelessWidget {
  ...
  const QrCodeSheet({
    ...
    this.title = 'Escaneie o QR Code',
    this.helperText = 'ou copie o código',
  });
  ...
  static void showAppointment(BuildContext context, {required String qrToken}) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (_) => QrCodeSheet(
        ...
        helperText: 'Token opaco do agendamento',
      ),
    );
  }
