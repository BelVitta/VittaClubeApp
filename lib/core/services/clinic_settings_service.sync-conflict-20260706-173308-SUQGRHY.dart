...
class ClinicSettingsService {
  ...
  static const int defaultMonthlyUsesPerDependent = 2;
  ...
  Future<int> getMaxDependentsPerHolder() {
    return getInt(
      kMaxDependentsPerHolder,
      defaultValue: defaultMaxDependentsPerHolder,
    );
  }

  Future<int> getMonthlyUsesPerDependent() {
    return getInt(
      kMonthlyUsesPerDependent,
      defaultValue: defaultMonthlyUsesPerDependent,
    );
  }

  Future<void> setMaxDependentsPerHolder(int value) {
    return set(kMaxDependentsPerHolder, value.toString());
  }

  Future<void> setMonthlyUsesPerDependent(int value) {
    return set(kMonthlyUsesPerDependent, value.toString());
  }
