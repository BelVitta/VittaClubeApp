...
import '../../features/subscription/domain/usecases/can_access_benefits_usecase.dart';
import '../../features/subscription/domain/usecases/can_use_qr_usecase.dart';
...
Future<void> init() async {
  ...
  // InfinityPay — checkout hospedado via link externo.
  sl.registerLazySingleton<InfinityPayCheckoutService>(
    () => InfinityPayCheckoutService(handle: AppConfig.instance.infinityPayHandle),
  );
  ...
  //============================================================
  // Features - Dependents (Dependentes)
  //============================================================

  sl.registerLazySingleton<DependentsSupabaseDataSource>(
    () => DependentsSupabaseDataSource(),
  );
  ...
  sl.registerFactory(
    () => SubscriptionBloc(
      ...
      createPixAutomaticSubscriptionUseCase: sl(),
  ...
  sl.registerLazySingleton(() => CanUseQrUseCase());
  sl.registerLazySingleton(() => CanAccessBenefitsUseCase());
