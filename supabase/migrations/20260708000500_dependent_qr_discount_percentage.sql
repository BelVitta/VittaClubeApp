-- Adiciona discount_percentage/plan_level na resposta 'approved' de
-- validate_dependent_qr, espelhando validate_member_qr, pra permitir que o
-- admin registre o valor da consulta do dependente com o desconto do plano
-- do titular (via ConsultationValueSheet, que já espera esse campo).
